...
$("#FAQ1-Dental_bridge-canal").click(function() {
	$("#content-FAQ1-Dental_bridge").slideToggle("slow");
});

$("#FAQ2-Dental_bridge-canal").click(function() {
	$("#content-FAQ2-Dental_bridge").slideToggle("slow");
});

$("#FAQ3-Dental_bridge-canal").click(function() {
	$("#content-FAQ3-Dental_bridge").slideToggle("slow");
});

$("#FAQ4-Dental_bridge-canal").click(function() {
	$("#content-FAQ4-Dental_bridge").slideToggle("slow");
});

$("#FAQ5-Dental_bridge-canal").click(function() {
	$("#content-FAQ5-Dental_bridge").slideToggle("slow");
});

$("#FAQ6-Dental_bridge-canal").click(function() {
	$("#content-FAQ6-Dental_bridge").slideToggle("slow");
});

$("#FAQ7-Dental_bridge-canal").click(function() {
	$("#content-FAQ7-Dental_bridge").slideToggle("slow");
});

$("#FAQ8-Dental_bridge-canal").click(function() {
	$("#content-FAQ8-Dental_bridge").slideToggle("slow");
});

$("#FAQ9-Dental_bridge-canal").click(function() {
	$("#content-FAQ9-Dental_bridge").slideToggle("slow");
});

$("#FAQ10-Dental_bridge-canal").click(function() {
	$("#content-FAQ10-Dental_bridge").slideToggle("slow");
});
